...
// Array of doctors
const doctors = [
    { id: 1, name: 'Dr. John Barns', specialty: 'Primary Care' },
    ...
    { id: 5, name: 'Dr. Peter williams', specialty: 'Gynecology' },
    { id: 6, name: 'Dr. Adam Brown', specialty: 'Vision Care' },
    { id: 7, name: 'Dr. Adam Brown', specialty: 'Emergency Care' }
];
